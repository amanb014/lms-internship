...
<!-- Page Content -->
        <div id="page-wrapper">
          ...
          <div class="panel panel-default">
                ...
                <div class= 
	                <?php
	                    if($_SESSION["instructor_insert"] == true) {
	                        echo "\"alert alert-success alert-dismissable\"";  
	                    } else if(isset($_SESSION["instructor_insert_fail"])){
                    ...
                    <?php
                        if($_SESSION["instructor_insert"] == true) {
                            ...
                            unset($_SESSION["instructor_insert"]);
                        }
                        if($_SESSION["instructor_insert_fail"] == true){
                            echo "Sorry, please check your connection to the database. Or contact your DBA.";
                            unset($_SESSION["instructor_insert_fail"]);
                        }
                    ?>
                </div>

                    <div class="row">
                        <form role="form" method="post" action="php/php_add_instructor.php">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <button type="submit" value="submit" class="btn btn-primary btn-lg btn-block">Add Instructor</button>
                            </div>
                        </div>                            
                        </form>
                    </div>
